...
do
  ...
  curl --request PUT --header 'PRIVATE-TOKEN: b******************k' --data "content=$(cat ./k8s-version-new.txt)" "https://gitlab.com/api/v4/projects/6226059/repository/files/kubernetes-version-list.txt?branch=master&commit_message=Update kubernetes-version-list.txt"
